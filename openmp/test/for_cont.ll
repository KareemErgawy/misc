; ModuleID = 'for_cont.cpp'
source_filename = "for_cont.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_for_cont.cpp, i8* null }]
...
for.body:                                         ; preds = %for.fork
  %call3 = call i32 @_Z8rand_valv()
  %call4 = call i32 @_Z8rand_valv()
  %cmp5 = icmp slt i32 %call3, %call4
...
if.end:                                           ; preds = %for.body
  ...
  %arrayidx7 = getelementptr inbounds float, float* %5, i64 %idxprom6
...
for.inc:                                          ; preds = %if.end, %if.then, %for.fork
  ...
  br i1 %cmp11, label %for.fork, label %for.join
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_for_cont.cpp() #2 section ".text.startup" {
entry:
